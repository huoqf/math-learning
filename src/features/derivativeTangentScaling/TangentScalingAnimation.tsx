    ...
    switch (mode) {
      ...
      case "sandwich":
        ...
        return {
          ...
          questions: [
            ...
            "(2) 利用基准放缩拆解综合不等式，证明双侧放缩不等式及等号同步条件",
          ],
        };
      case "param_k":
        return {
      ...
      case "secant":
        ...
        if (secantSubModel === "log_secant_tangent") {
          return {
            conditions: [
              "在闭区间 $[a,b]$ 上考查对数函数 $\\ln x$ 的割线与中点切线",
              "割线连接端点 $A(a, \\ln a)$ 与 $B(b, \\ln b)$",
            ],
            questions: [
              "(1) 求端点割线方程与区间中点切线方程，并计算割线斜率",
              "(2) 构造差函数利用导数证明在 $[a,b]$ 上割线在下（下界）、切线在上（上界）",
            ],
          };
        }
        return {
          conditions: [
            "在闭区间 $[a,b]$ 上考查指数函数 $e^x$ 的割线与中点切线",
            "割线连接端点 $A(a, e^a)$ 与 $B(b, e^b)$",
          ],
          questions: [
            "(1) 求端点割线方程与区间中点切线方程，并计算割线斜率",
            "(2) 构造差函数利用导数证明在 $[a,b]$ 上切线在下（下界）、割线在上（上界）",
          ],
        };
    }
  }, [mode, baseSubModel, sandwichSubModel, paramKSubModel, secantSubModel]);
