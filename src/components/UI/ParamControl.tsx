    ...
    return (
      <div key={param.key} className="space-y-2.5 pb-4 border-b border-neutral-100 last:border-0 last:pb-0">
        <div className="flex items-start justify-between gap-2">
          <label className="min-w-0 text-xs font-semibold text-neutral-700 leading-6" htmlFor={`param-${param.key}`}>
            <span className="inline-flex items-center gap-1.5">
              ...
              {param.importance && (
                <span className={['rounded-full px-1.5 py-0.5 text-[10px] font-bold border', importanceBadgeClass[param.importance]].join(' ')}>
        ...
        {marks.some((mark) => mark.label) && (
          <div className="relative h-4 text-[10px] font-semibold w-full" style={{ paddingLeft: '44px', paddingRight: '44px' }}>
