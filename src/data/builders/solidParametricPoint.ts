...
export function buildParametricPointPanel(
  ...
  if (mode === "singlePointAngle") {
    ...
    examAnchor = "高考压轴大题 · 空间双动点多元二次型最值与公垂线";
    ...
    examAnchor = "高考经典题型 · 动点几何体极值与等体积转化";
    ...
    examAnchor = "高考与竞赛经典 · 多面体表面动点最短路径化曲为平";
