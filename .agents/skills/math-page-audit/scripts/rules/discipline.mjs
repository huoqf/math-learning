...
const BEYOND_SYLLABUS_TERMS = [
  ...
  '琴生',
  '极点极线',
  // 极点/极线族拆分变体（2026-09-25 补：曾有一页把「极点极线」包装成课标内的「切点弦」，
  // 正文只用「极线对偶公式」「外部极点」这类拆分表述，因黑名单只收录四字整串而被静默放行）
  '极线',
  '极点',
  '克拉默',
  '外积',
  ...
  '微元',
  '定积分',
  // 三垂线族（2026-09-25 补：三垂线定理属旧大纲内容，2019 人教A版新课标已删，
  // 本库统一改用「线面垂直的判定与性质」表述，禁止再以该名出现于正文）
  '三垂线',
  '极坐标',
  '参数方程',
  '行列式',
