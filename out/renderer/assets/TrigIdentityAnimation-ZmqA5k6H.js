...
import { av as calculateTrigIdentity, aw as calculateInduction, ax as pointToAngleDeg, b as buildMathQuantities } from "./mathQuantities-CSLRzday.js";
...
const TrigIdentityScene = ({
  ...
  const pPrimeDesign = mathToDesign(ind.pointPPrime.x, ind.pointPPrime.y, scale);
  const mPrimeDesign = mathToDesign(ind.pointMPrime.x, ind.pointMPrime.y, scale);
...
function TrigIdentityAnimation() {
  const [studyMode, setStudyMode] = reactExports.useState("identity");
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectGrid,
              {
                items: [
                  ...
                  { key: "pi_minus", label: "π - α", formula: "\\pi - \\alpha" },
                  {
                    key: "half_pi_minus",
                    label: "π/2 - α",
