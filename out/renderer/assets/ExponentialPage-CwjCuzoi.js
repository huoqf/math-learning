...
import { d as defaultParams, p as paramMeta, E as ExpLogScene } from "./funcExpLog-MXg5XSqK.js";
...
function ExponentialPage() {
  ...
  const formulaLatex = reactExports.useMemo(() => {
    ...
    return showInverse ? `y = \\color{${MATH_COLORS.paramPrimary}}{${aVal}}^x \\iff x = \\log_{\\color{${MATH_COLORS.paramPrimary}}{${aVal}}} y` : `y = \\color{${MATH_COLORS.paramPrimary}}{${aVal}}^x`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ThreePanel,
    {
      left: /* @__PURE__ */ jsxRuntimeExports.jsxs(LeftPanel, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LeftPanelSection, { title: "指数函数", subtitle: "y = aˣ 的图像与性质", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-xs text-neutral-600 cursor-pointer select-none", children: [
